                ...
                <form method="post">
                    ...
                    <table class="form-table" role="presentation">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        <br>
                                        <p class="description">Select option as Effects first with second tap to open link or works normally as click to open link.</p>
                                    </fieldset>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        <br>
                                        <p class="description">Load Way Points at shortcode loading while animated, If your theme already loaded select No for faster loading</p>
                                    </fieldset>
                                </td>
                            </tr>
                            <tr> 
                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        <br>
                                        <p class="description">Load Google font from Google  while loading shortcode, If you already load those locally select No for faster loading</p>
                                    </fieldset>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="oxi_addons_custom_parent_class">Fixed Header Size</label>
                                </th>
                                <td class="valid">
                                    <input type="text" class="regular-text" id="oxi_addons_custom_parent_class" name="oxi_addons_custom_parent_class" value="<?php echo get_option('oxi_addons_custom_parent_class'); ?>">
                    ...
                    <table class="form-table" role="presentation">
                        <tbody>
                            <tr>
                                ...
                                <td class="valid">
                                    <input type="text" class="regular-text" id="image_hover_ultimate_license_key" name="image_hover_ultimate_license_key" value="<?php echo $this->license; ?>">
