...
var downloadButton8 = document.getElementById("download8");
var counter8 = 60;
var newElement8 = document.createElement("p");
newElement8.innerHTML = "You are left with 60 seconds.";
var id8;
downloadButton8.parentNode.replaceChild(newElement8, downloadButton8);
id8 = setInterval(function() {
counter8--;
if(counter8 < 0) {
newElement8.parentNode.replaceChild(downloadButton8, newElement8);
clearInterval(id8);
} else {
newElement8.innerHTML = "<span style='color: white;'>You are left with " + counter8.toString() + " seconds.</span>";
}}, 1000);
}
var red = 0;
function myFunctionRed(tip) {
red+=1;
var newElementRed = document.getElementById("Red");
newElementRed.innerHTML = "Red has won " + red.toString() + " points.";
var newElementred = document.getElementById(tip.toString());
newElementred.innerHTML = "Red has won 1 point.";
}

var blue = 0;
function myFunctionBlue(tip1) {
blue+=1;
var newElementBlue = document.getElementById("Blue");
newElementBlue.innerHTML = "Blue has won " + blue.toString() + " points.";
var newElementblue = document.getElementById(tip1.toString());
newElementblue.innerHTML = "Blue has won 1 point.";
}

var green = 0;
function myFunctionGreen(tip2) {
green+=1;
var newElementGreen = document.getElementById("Green");
newElementGreen.innerHTML = "Green has won " + green.toString() + " points.";
var newElementgreen = document.getElementById(tip2.toString());
newElementgreen.innerHTML = "Green has won 1 point.";
}

var yellow = 0;
function myFunctionYellow(tip3) {
yellow+=1;
var newElementYellow = document.getElementById("Yellow");
newElementYellow.innerHTML = "Yellow has won " + yellow.toString() + " points.";
var newElementyellow = document.getElementById(tip3.toString());
newElementyellow.innerHTML = "Yellow has won 1 point.";
}
</script>
